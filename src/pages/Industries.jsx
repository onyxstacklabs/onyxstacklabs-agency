...
export default function Industries({ currentPath, navigateToNode }) {
  ...
  const deliveryWorkflowPhases = [
    ...
    { id: "02", phaseName: "Atomic Component Engineering", desc: "Interfaces are broken down into self-contained, isolated React components styled with utility utility frameworks to guarantee rapid visual consistency." },
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-neutral-100 font-sans antialiased selection:bg-[#06B6D4] selection:text-black relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[700px] bg-[radial-gradient(ellipse_at_top,rgba(6,182,212,0.05),transparent_60%)] pointer-events-none z-0" />
      <div className="absolute top-[1500px] right-0 w-[400px] h-[400px] bg-cyan-500/[0.01] blur-[150px] pointer-events-none" />
      <div className="absolute bottom-[800px] left-0 w-[500px] h-[500px] bg-blue-600/[0.015] blur-[180px] pointer-events-none" />
      ...
      <div className="relative z-10 orchestration-industries-scope">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 pt-32 pb-16 sm:pt-40 sm:pb-24">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-white mb-6 leading-[1.1] font-sans">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#06B6D4] via-cyan-200 to-blue-400">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="bg-white hover:bg-[#06B6D4] text-black px-6 py-3.5 rounded-full text-xs font-bold font-mono uppercase tracking-widest transition-all duration-300 hover:shadow-[0_0_20px_rgba(6,182,212,0.3)]"
              >
                Initiate Architecture Audit
              </button>
              <button
                onClick={() => {
                  const el = document.getElementById('verticals-grid');
                  el?.scrollIntoView({ behavior: 'smooth' });
                }}
                className="border border-neutral-800 hover:border-neutral-700 bg-neutral-950/40 text-neutral-300 px-6 py-3.5 rounded-full text-xs font-bold font-mono uppercase tracking-widest transition-colors duration-200"
              >
        ...
        <section id="verticals-grid" className="max-w-7xl mx-auto px-6 md:px-12 py-12 scroll-mt-24">
          <div className="border-b border-neutral-900 pb-4 mb-12">
            <h2 className="text-xs font-mono uppercase tracking-widest text-[#06B6D4]">// Sector Matrix Selectors</h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-2">
              {industryCatalog.map((ind, iIdx) => (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-xl border transition-all duration-200 flex items-center gap-4 group ${selectedIndustry === iIdx ? 'bg-neutral-950 border-[#06B6D4]/30 text-[#06B6D4] shadow-[inset_0_0_12px_rgba(6,182,212,0.03)]' : 'bg-transparent border-neutral-900/60 text-neutral-400 hover:text-neutral-200 hover:border-neutral-800'}`}
                >
                  <div className={`p-2 rounded-md transition-colors ${selectedIndustry === iIdx ? 'bg-[#06B6D4]/10 text-[#06B6D4]' : 'bg-neutral-900/50 text-neutral-500 group-hover:text-neutral-300'}`}>
                    {ind.icon}
                  </div>
            ...
            <div className="lg:col-span-8 p-6 sm:p-10 rounded-2xl border border-neutral-900 bg-gradient-to-br from-neutral-950 to-neutral-900/10 min-h-[460px] flex flex-col justify-between relative">
              <div className="absolute top-0 right-0 w-72 h-72 bg-[#06B6D4]/[0.02] blur-[80px] pointer-events-none rounded-full" />
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {industryCatalog[selectedIndustry].solutions.map((sol, sIdx) => (
                        <span key={sIdx} className="px-3 py-1.5 rounded-md bg-neutral-900 border border-neutral-800 text-xs font-mono text-neutral-200">
                          {sol}
                        </span>
                      ))}
                    </div>
              ...
              <div className="mt-8 pt-6 border-t border-neutral-900">
                <h4 className="text-xs font-mono uppercase tracking-widest text-[#06B6D4] mb-2">Target Corporate Outcomes</h4>
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-20 border-t border-neutral-900/60">
          <div className="max-w-3xl mb-16">
            <p className="text-xs font-mono uppercase tracking-widest text-[#06B6D4] mb-3">Operational Guarantees</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {premiumValuePillars.map((pillar, pIdx) => (
              <div key={pIdx} className="p-6 rounded-xl border border-neutral-900 bg-neutral-950/40 hover:border-neutral-800/80 transition-colors duration-200">
                <div className="w-1.5 h-6 bg-[#06B6D4] mb-4 rounded-full" />
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-20 border-t border-neutral-900/60">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5">
              <p className="text-xs font-mono uppercase tracking-widest text-[#06B6D4] mb-3">Consolidated Tech Ecosystem</p>
            ...
            <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-4">
              {[
                ...
                { name: "MongoDB Infrastructure", dial: "Dynamic Object Schemas" },
                ...
                <div key={teIdx} className="p-4 rounded-xl border border-neutral-900 bg-neutral-950/60">
                  <h4 className="text-xs font-bold text-white mb-1 font-mono">{techElement.name}</h4>
                  <p className="text-[10px] text-neutral-500 uppercase tracking-wider font-sans">{techElement.role || techElement.dial}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-20 border-t border-neutral-900/60">
          <div className="max-w-3xl mb-16">
            <p className="text-xs font-mono uppercase tracking-widest text-[#06B6D4] mb-3">Delivery Engineering</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            {deliveryWorkflowPhases.map((phase, phIdx) => (
              <div key={phIdx} className="p-6 rounded-xl border border-neutral-900 bg-gradient-to-b from-neutral-950 to-[#050505] relative group">
                <div className="absolute top-4 right-4 text-xs font-mono font-bold text-neutral-800 group-hover:text-[#06B6D4]/40 transition-colors">
                  #{phase.id}
                </div>
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-16 sm:py-24 border-t border-neutral-900/60">
          <div className="p-8 sm:p-14 rounded-3xl border border-neutral-900 bg-gradient-to-tr from-neutral-950 via-neutral-950 to-neutral-900/30 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
