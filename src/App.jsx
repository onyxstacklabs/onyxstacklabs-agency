...
export default function App() {
  ...
  // Value Proposition Strategic Grid Array (Enhanced matching requested criteria)
  const valueProps = [
    ...
    <div className="min-h-screen bg-[#050505] text-neutral-100 font-sans antialiased selection:bg-[#06B6D4] selection:text-black scroll-smooth">
      ...
      <footer className="border-t border-neutral-900 bg-[#050505] py-16 px-6 relative z-10" aria-label="Agency Directory Info">
        ...
        <div className="border-t border-neutral-900/60 pt-8 max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
          <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-3 font-mono text-[10px] font-bold uppercase tracking-widest text-neutral-500">
            
            {/* YouTube Link */}
            <a href={siteConfig.socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#06B6D4] transition-colors group">
              <svg className="w-3 h-3 fill-current text-neutral-600 group-hover:text-[#06B6D4] transition-colors" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* LinkedIn Link */}
            <a href={siteConfig.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#06B6D4] transition-colors group">
              <svg className="w-3 h-3 fill-current text-neutral-600 group-hover:text-[#06B6D4] transition-colors" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Facebook Link */}
            <a href={siteConfig.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#06B6D4] transition-colors group">
              <svg className="w-3 h-3 fill-current text-neutral-600 group-hover:text-[#06B6D4] transition-colors" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Instagram Link */}
            <a href={siteConfig.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#06B6D4] transition-colors group">
              <svg className="w-3 h-3 fill-current text-neutral-600 group-hover:text-[#06B6D4] transition-colors" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* TikTok Link */}
            <a href={siteConfig.socialLinks.tiktok} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#06B6D4] transition-colors group">
              <svg className="w-3 h-3 fill-current text-neutral-600 group-hover:text-[#06B6D4] transition-colors" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href={siteConfig.socialLinks.whatsapp} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#00e676] hover:text-emerald-400 transition-colors group">
              <svg className="w-3 h-3 fill-current text-[#00e676] group-hover:text-emerald-400 transition-colors" viewBox="0 0 24 24" aria-hidden="true">
