...
export default function App() {
  ...
  // Verified Production Ecosystem Array - Preserved URL Nodes & Content Restructured for High-Ticket Conversion
  const activeProjects = [
    {
      id: "tailors-node",
      title: "Gul Tailors AI",
      subTitle: "Intelligent Custom Tailoring Platform",
      description: "An automated order and measurement system leveraging Gemini AI to parse handwritten customer records and photos into a structured digital database.",
    ...
    },
    {
      id: "mudra-node",
      title: "Mudra Ledger",
      subTitle: "Digital Accounting & Finance Portal",
      description: "A highly secure business ledger and interactive financial tracking dashboard tailored for real-time transaction history, balance updates, and cash flow analysis.",
      tags: ["React", "Cloud Firestore", "Tailwind UI"],
      isLive: false,
      appUrl: "https://onyxstack-mudra.vercel.app"
    },
    {
      id: "school-node",
      title: "OnyxStack School ERP",
      subTitle: "Enterprise Academy Management System",
      description: "A complete, multi-tenant administrative software suite automating student records, educational workflows, staff oversight, and real-time fee collection status.",
    ...
    {
      id: "gatepass-node",
      title: "GatePass Secure",
      subTitle: "Smart QR Code Visitor Verification",
      description: "Advanced gate verification software utilizing dual-camera snapshot logic to capture visitor entry, process secure QR access keys, and log automated security histories.",
      tags: ["React", "Firebase Auth", "Hardware Integration"],
      isLive: true,
    ...
    },
    {
      ...
      subTitle: "Live Digital Campaign Selection App",
      description: "A high-performance promotional drawing platform built with synchronized state management to handle thousands of concurrent users during live target engagement giveaways.",
      tags: ["React.js", "Realtime DB", "Custom UI Effects"],
      isLive: true,
      appUrl: "https://onyxstack-lottery.vercel.app"
    },
    {
      id: "cricket-node",
      title: "ProScore Cricket",
      subTitle: "Live Sports Scoring Infrastructure",
      description: "An ultra-responsive digital scoring application delivering instant match summaries, point tables, player analytics, and ball-by-ball tournament scorecards.",
      tags: ["React", "Vite Engine", "Live Data Sync"],
      isLive: false,
      appUrl: "https://onyxstack-cricket.vercel.app"
    }
  ];

  // Modern Services Matrix Array
  const coreServices = [
    {
      icon: (
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-neutral-100 font-sans antialiased selection:bg-cyan-500 selection:text-black scroll-smooth">
      
      {/* Premium Backdrop Aesthetic Glow Nodes */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[600px] bg-[radial-gradient(ellipse_at_top,rgba(34,211,238,0.06),transparent_50%)] pointer-events-none z-0" />
      <div className="absolute top-[1800px] right-0 w-[400px] h-[400px] bg-cyan-500/[0.02] blur-[150px] pointer-events-none" />
      <div className="absolute bottom-[800px] left-0 w-[500px] h-[500px] bg-emerald-500/[0.01] blur-[180px] pointer-events-none" />
      ...
      <nav className="sticky top-0 z-50 border-b border-neutral-900 bg-black/60 backdrop-blur-xl px-6 md:px-12 py-4" aria-label="Main Navigation">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <a href="#" className="flex items-center gap-3 group focus:outline-none focus:ring-2 focus:ring-cyan-400 rounded-md p-1" aria-label="OnyxStack Labs Homepage">
            <div className="w-3 h-3 rounded-full bg-cyan-400 shadow-[0_0_15px_#22d3ee] group-hover:scale-110 transition-transform duration-300"></div>
            <span className="text-lg font-bold tracking-tight uppercase font-mono">
              OnyxStack<span className="text-cyan-400 font-sans tracking-normal lowercase font-semibold">Labs</span>
            </span>
          </a>
          ...
          <div className="flex items-center gap-4">
            ...
            <a 
              href="#contact" 
              className="bg-neutral-100 hover:bg-cyan-400 text-black px-5 py-2 rounded-full text-xs font-bold uppercase tracking-wider transition-all duration-300 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-cyan-400"
            >
              Start Project
            </a>
          </div>
      ...
      <header className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-20 text-center md:pt-36 md:pb-32 space-y-8">
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tighter text-white uppercase leading-none">
            Build Modern Software <br className="hidden md:inline" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-100 via-neutral-300 to-cyan-400">
              That Grows Your Business
            </span>
          </h1>
          <p className="text-base sm:text-xl text-neutral-400 max-w-2xl mx-auto leading-relaxed font-normal">
            We build scalable Web Apps, Android Apps, AI Solutions, and intuitive Business Management Systems optimized for startups, schools, and enterprise platforms.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
          <a 
            href="#contact" 
            className="w-full sm:w-auto bg-cyan-400 hover:bg-cyan-300 text-black px-8 py-4 rounded-xl font-bold text-sm tracking-wide shadow-[0_4px_25px_rgba(34,211,238,0.15)] transition-all duration-300 transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-cyan-300 text-center"
          >
            Start Your Project
          </a>
          <a 
        ...
        {/* Client-Centric Trust Credential Badges & Metrics Row */}
        <div className="pt-16 md:pt-24 border-t border-neutral-900/60 max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-4">
          {[
            ...
            <div key={idx} className="space-y-1 group">
              <div className="text-2xl md:text-3xl font-extrabold text-white group-hover:text-cyan-400 transition-colors duration-300 font-mono">{stat.metric}</div>
      ...
      {/* --- NEW CORE PREMIUM SERVICES SECTION --- */}
      <section id="services" className="relative z-10 border-t border-neutral-900 bg-neutral-950/40 py-24 px-6" aria-labelledby="services-title">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center space-y-4">
            <h2 id="services-title" className="text-xs font-mono font-bold uppercase tracking-widest text-cyan-400">Capabilities Matrix</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreServices.map((service, idx) => (
              <div 
                key={idx} 
                className="bg-neutral-950 border border-neutral-900/80 rounded-2xl p-6 space-y-4 hover:border-cyan-500/30 transition-all duration-300 group"
              >
                <div className="w-12 h-12 rounded-xl bg-neutral-900 flex items-center justify-center border border-neutral-800 group-hover:bg-cyan-950/30 group-hover:border-cyan-500/20 transition-all duration-300">
                  {service.icon}
                </div>
                <h3 className="text-lg font-bold text-neutral-100 group-hover:text-cyan-400 transition-colors duration-300">{service.title}</h3>
      ...
      {/* --- RESTORED LIVE PRODUCTION ECOSYSTEM SECTION - ZERO DROPPED URLs --- */}
      <section id="portfolio" className="relative z-10 py-24 px-6 max-w-7xl mx-auto space-y-16" aria-labelledby="portfolio-title">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-neutral-900 pb-8">
          <div className="space-y-4">
            <h2 id="portfolio-title" className="text-xs font-mono font-bold uppercase tracking-widest text-cyan-400">Selected Product Deployments</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {activeProjects.map((project) => (
            ...
            >
              {project.isLive && (
                <span className="absolute top-4 right-4 bg-emerald-950/60 border border-emerald-500/30 text-emerald-400 text-[10px] font-mono font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wider flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping"></span> Live Setup
                </span>
              )}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-[10px] font-mono font-semibold text-cyan-500 tracking-wider uppercase mt-1">{project.subTitle}</p>
                </div>
              ...
              <div className="mt-6 space-y-4 pt-4 border-t border-neutral-900/60">
                ...
                <a 
                  ...
                  className="w-full bg-neutral-900 hover:bg-cyan-400 border border-neutral-800 text-neutral-200 hover:text-black font-semibold text-xs py-3 px-4 rounded-xl flex items-center justify-center gap-2 group/btn transition-all duration-300 text-center"
                  aria-label={`Launch deployment instance demo for ${project.title}`}
                >
      ...
      {/* --- NEW STRATEGIC WHY CHOOSE US SECTION --- */}
      <section id="why-choose-us" className="relative z-10 border-t border-neutral-900 bg-neutral-950/20 py-24 px-6" aria-labelledby="why-us-title">
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="text-center space-y-4">
            <h2 id="why-us-title" className="text-xs font-mono font-bold uppercase tracking-widest text-cyan-400">Our Strategic Advantage</h2>
      ...
      {/* --- NEW PIPELINE DELIVERY TIMELINE PROCESS SECTION --- */}
      <section id="process" className="relative z-10 border-t border-neutral-900 py-24 px-6 max-w-7xl mx-auto space-y-16" aria-labelledby="process-title">
        <div className="text-center space-y-4">
          <h2 id="process-title" className="text-xs font-mono font-bold uppercase tracking-widest text-cyan-400">Execution Timeline</h2>
          ...
          {deliveryProcess.map((proc, idx) => (
            <div key={idx} className={`relative flex flex-col md:flex-row items-start mb-12 last:mb-0 ${idx % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
              <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-black border border-neutral-800 flex items-center justify-center z-10 shadow-[0_0_10px_rgba(0,0,0,0.8)]">
                <span className="text-[10px] font-mono text-cyan-400 font-bold">{proc.step}</span>
              </div>
      ...
      <section className="relative z-10 border-t border-neutral-900 bg-neutral-950/30 py-20 px-6" aria-labelledby="tech-title">
        <div className="max-w-5xl mx-auto space-y-10">
          <div className="text-center space-y-2">
            <h2 id="tech-title" className="text-xs font-mono font-bold uppercase tracking-widest text-cyan-400">The Technology Architecture Blueprint</h2>
          ...
          {submissionState === 'SUCCESS' ? (
            <div className="bg-neutral-900/60 border border-emerald-500/30 rounded-2xl p-8 text-center space-y-5 animate-fadeIn">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-emerald-400 font-mono uppercase tracking-wide">Project Request Cached</h3>
              ...
              <button 
                ...
                className="text-xs text-cyan-400 hover:text-cyan-300 font-mono uppercase tracking-widest pt-2 font-bold focus:outline-none focus:underline"
              >
            ...
            <form onSubmit={handleLeadFormTransmission} className="space-y-6">
              ...
              <button 
                type="submit"
                disabled={submissionState === 'SUBMITTING'}
                className="w-full bg-cyan-400 hover:bg-cyan-300 disabled:bg-cyan-950 disabled:text-cyan-700 text-black font-extrabold text-xs uppercase tracking-widest py-4 px-4 rounded-xl shadow-[0_4px_25px_rgba(34,211,238,0.15)] transition-all duration-300 flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-cyan-400"
              >
      ...
      <footer className="border-t border-neutral-900 bg-black py-16 px-6 relative z-10" aria-label="Agency Directory Info">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 pb-12">
          ...
          <div className="space-y-4 md:col-span-2">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-bold tracking-widest uppercase text-white font-mono">OnyxStack Labs</h3>
            </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-neutral-500 font-normal">
              ...
              <li><a href="#services" className="hover:text-cyan-400 transition-colors">Android Mobile Apps</a></li>
              <li><a href="#services" className="hover:text-cyan-400 transition-colors">AI System Automation</a></li>
              <li><a href="#services" className="hover:text-cyan-400 transition-colors">Management ERP Core</a></li>
            </ul>
          </div>
        ...
        {/* Dynamic Social Ecosystem Matrix Links Grid with Original Links Intact */}
        <div className="border-t border-neutral-900 pt-8 max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
          <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-3 font-mono text-[11px] font-bold uppercase tracking-widest text-neutral-400">
            ...
            {/* YouTube Link */}
            <a href="https://youtube.com/@onyxstacklabs" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-cyan-400 transition-colors group">
            ...
            {/* LinkedIn Link */}
            <a href="https://linkedin.com/company/onyxstacklabs" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-cyan-400 transition-colors group">
              <svg className="w-3.5 h-3.5 fill-current text-neutral-500 group-hover:text-cyan-400 transition-colors" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Facebook Link */}
            <a href="https://facebook.com/onyxstacklabs" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-cyan-400 transition-colors group">
              <svg className="w-3.5 h-3.5 fill-current text-neutral-500 group-hover:text-cyan-400 transition-colors" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Instagram Link */}
            <a href="https://instagram.com/onyxstacklabs" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-cyan-400 transition-colors group">
              <svg className="w-3.5 h-3.5 fill-current text-neutral-500 group-hover:text-cyan-400 transition-colors" viewBox="0 0 24 24" aria-hidden="true">
